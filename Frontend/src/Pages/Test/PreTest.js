...
import { updatePreTestInfo } from '../../redux/actions/index.js'; // Update this import path as per your project structure
import BeatLoader from "react-spinners/BeatLoader";

const PreTest = ({ onCompletion, title }) => {
    ...
    const finishQuestions = () => {
        ...
        dispatch(updatePreTestInfo(timeTaken, score, generateTextContent()));
    ...
    return (
        <div className=" mx-auto py-4 px-8 relative">
            ...
            : 
            <div>
            <h2 className="text-2xl font-semibold my-6">{title || 'Pre Test'}</h2>
            {!showQuestions ? (
                <button

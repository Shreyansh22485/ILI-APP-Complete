...
import { updatePreTestInfo, updatePostTestInfo, updateLectureInfo, resetBrailleTraining } from '../../redux/actions';
...
export default function TestOld() {
    ...
    const [currentPhase, setCurrentPhase] = useState('PreTest');    const [timings, setTimings] = useState({ PreTest: null, Lecture: null, PostTest: null });
    ...
    useEffect(() => {
        ...
        // Clear any Braille training state for traditional tests
        ...
        navigator.mediaDevices.getUserMedia({ video: true, audio: true })
            .then(stream => {
                ...
                // Reset any previous Braille training state for traditional test
                dispatch(resetBrailleTraining());
            })
            .catch(err => {

...
import { STORE_BRAILLE_LETTER_RESULTS, STORE_BRAILLE_WORD_RESULTS, UPDATE_BRAILLE_TRAINING_PHASE, RESET_BRAILLE_TRAINING } from './actionTypes';
...
// Braille training actions
export const storeBrailleLetterResults = (studentId, letterStats, overallStats) => ({
    type: STORE_BRAILLE_LETTER_RESULTS,
    payload: { studentId, letterStats, overallStats, completedAt: new Date().toISOString() }
});

export const storeBrailleWordResults = (studentId, wordStats, overallStats) => ({
    type: STORE_BRAILLE_WORD_RESULTS,
    payload: { studentId, wordStats, overallStats, completedAt: new Date().toISOString() }
});

export const updateBrailleTrainingPhase = (phase) => ({
    type: UPDATE_BRAILLE_TRAINING_PHASE,
    payload: phase
});

export const resetBrailleTraining = () => ({
    type: RESET_BRAILLE_TRAINING
});
